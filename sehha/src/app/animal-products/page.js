    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="max-w-2xl mx-auto mb-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <Link href="/cart">
            <button className="w-full sm:w-auto bg-orange-500 text-white py-2 px-6 rounded-lg font-medium hover:bg-amber-400 transition-colors duration-300 flex items-center justify-center">
